  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved snippet as @snippet" do
        ...
        post :create, {:snippet => { "post" => "invalid value" }}, valid_session
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested snippet" do
        ...
        Snippet.any_instance.should_receive(:update_attributes).with({ "post" => "MyText" })
        put :update, {:id => snippet.to_param, :snippet => { "post" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the snippet as @snippet" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Snippet.any_instance.stub(:save).and_return(false)
        put :update, {:id => snippet.to_param, :snippet => { "post" => "invalid value" }}, valid_session
        assigns(:snippet).should eq(snippet)
      end
